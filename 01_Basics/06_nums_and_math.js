...
console.log(Math.floor(Math.random()*10) + 1); // value from 1 to 10

const min = 10
const max = 20 

console.log( Math.floor( (Math.random() * (max - min + 1) ) + min) )
// will give the value min 10 to max 20

// refer console, use 'console.log(Math)' to see more function
